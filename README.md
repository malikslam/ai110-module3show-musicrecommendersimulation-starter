...
![Terminal output showing recommendations for Rock/Intense ](![alt text](images/terminal_output-0.png))

![Terminal output showing recommendations for Pop/Happy profiles](![alt text](![alt text](images/terminal_output-1.png)))
